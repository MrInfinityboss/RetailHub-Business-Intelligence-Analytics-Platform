...
ROUND(SUM(p.amount),2) revenue,

ROUND(AVG(p.amount),2) average_order_value
...
ROUND(SUM(p.amount),2) lifetime_value
...
ROUND(SUM((oi.unit_price*oi.quantity)-oi.discount+oi.tax),2) revenue,
